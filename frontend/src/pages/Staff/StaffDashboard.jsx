    ...
    <div className="staff-dashboard-page">
      ...
      {!effectivePosition && (
        <div className="staff-dashboard-alert">
          Tài khoản của bạn chưa được admin gán vị trí làm việc. Hãy liên hệ
          quản trị viên để được cấp quyền đúng nghiệp vụ.
        </div>
      )}
      ...
      <div className="staff-dashboard-grid">
        ...
        <div className="staff-feature-card">
          ...
          <p>
            Tạo hóa đơn chỉ gồm bắp nước hoặc combo quầy, không cần chọn vé hay
            suất chiếu. Phù hợp cho khách mua thêm tại quầy.
          </p>
          <button
            onClick={() => navigate("/staff/combo-sales")}
            disabled={!canConcession}
          >
            Mở bán combo
          </button>
        </div>
        ...
        <div
          className={`staff-feature-card ${showScanner ? "active-scanner" : ""}`}
        >
          <div className="staff-feature-icon">
            <LuTicketCheck />
          </div>
          <h2>Soát vé QR</h2>
          <p>
            Quét mã QR hoặc nhập mã vé thủ công để tra cứu và xác nhận check-in
            cho khách hàng.
          </p>
          ...
          <div className="staff-feature-actions">
            ...
            >
              {showScanner ? (
                ...
                <>
                  <BsQrCodeScan className="scan-icon" /> Mở scanner nhanh
                </>
              )}
            </button>
          </div>
